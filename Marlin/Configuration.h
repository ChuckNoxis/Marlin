...
#define CUSTOM_MACHINE_NAME "Noxis3D"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  29.04,  25.62, 28.14 }
    #define DEFAULT_Ki_LIST {   2.61,   2.54,  2.68 }
    #define DEFAULT_Kd_LIST {  80.88,  64.68, 73.89 }
  #else
    #define DEFAULT_Kp  28.14
    #define DEFAULT_Ki   2.68
    #define DEFAULT_Kd  73.89
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 143.78 }
...
#define Z_PROBE_SPEED_SLOW HOMING_FEEDRATE_Z //HOMING_FEEDRATE_Z = 4
